...
Here is the [Back-End](https://github.com/johnie261/hello-rails-back-end) of the app.
...
```sh
 git clone https://github.com/johnie261/hello-react-front-end
```
...
Feel free to check the [issues page](https://github.com/johnie261/hello-react-front-end/issues).
